...
public class SecurityConfig {
    ...
    /*
        Spring Checks If You have defined any FilterChain if Not it Executes its Own
        SecurityFilterChain

        CSRF and CORS in FrontEnd

        login , refreshToken , signUp request are public they should be permitted
        Other should go through Authentication
    */
    @Bean
